             ...
             function onFileSystemSuccess(fileSystem) {
				fileSystem.root.getFile("dummy.html", {create: true, exclusive: false}, 
					function gotFileEntry(fileEntry) {
						...
						fileTransfer.download(uri, fileSystem.root.toURL() + "tempFile.pdf",
								function(theFile) {
									console.log(fileSystem.root.toURL() + "tempFile.pdf");
									//sap.m.MessageToast.show("Pobrano plik: "+theFile.toURL());
									openDoc(fileSystem.root.toURL() + "tempFile.pdf");
								},
								function(error) {
